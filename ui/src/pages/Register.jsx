...
const Register = () => {
  ...
  function HandleSubmit(e){
    e.preventDefault();
    axios.post('http://localhost:3001/register',{name:user.name,email:user.email,password:user.password,confirmPassword:user.confirmPassword}).then(result=>console.log(result)).catch(error=>console.log(error))
